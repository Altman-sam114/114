...
- 统计页作为 Pro 内购功能：普通用户可体验今日概览和 Pro 预览，Pro 用户解锁近 7 日、分类投入占比和专注次数、带分类上下文和 Voice Control 输入标签的最近记录、带分类 badge 和语音语义的日程计划回顾、工作压力、任务安排分析，以及日/周/月工作复盘报表。
