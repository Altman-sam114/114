...
- 当前云端 CI 结果包覆盖静态检查、项目验证、`ChronoFocusMac` build、`ChronoFocus` iOS generic build、artifact index、index totals 一致性、run context、static-checks 日志 marker、分类可访问 contract marker、Mac 快照 manifest 和失败阶段关键错误摘录。
