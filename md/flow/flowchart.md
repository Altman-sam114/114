...
flowchart TD
  ...
  ART --> C["Agent C<br/>gh auth login<br/>下载 artifact 到 /private/tmp/chronofocus-c-review-run_id<br/>核对 manifest artifactName、artifact index、index totals、run context、artifact 名称、计划面板操作/日程toolbar新增/Mac快速新增/Mac小窗快捷面板 marker 和快照 manifest"]
