...
flowchart TD
  ...
  S --> T["测试入口<br/>test_mac_core.swift<br/>render_mac_snapshots.swift<br/>快照 manifest<br/>verify_project.sh<br/>分类摘要接线、动作可访问提示、快捷新增、点击切换、selected trait 和 Voice Control 标签检查<br/>validator 复判 static-checks、Xcode 版本与分类可访问日志 marker<br/>validator 正向/错包/index错包/totals错包/缺失产物 fixture"]
```
